...
<head>
    <meta charset="UTF-8">
    <title>Reporte Nómina por Estado</title>
    <style type="text/css">
        .col-md-12 {
            width: 100%;
        }
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td class="blanco" colspan="5" style="border: 1px solid white;">
                    <div align="center">
                        <img src="{{env('URL_PATH_LOCAL_IMAGE')}}/ug.png" height="120px"/>
                        <hr>
                    </div>
                </td>
            </tr>
            <tr>
                <td class="blanco" colspan="5" style="border: 1px solid white; background: lightgrey;">
                    ...
                    <div align="center" style="height: 20px"><b><u>REPORTE NÓMINA POR ESTADO</u></b></div>
                </td>
            </tr>
            <tr>
                <td class="blanco" colspan="5" style="border: 1px solid white;">
            ...
            <tr>
                ...
                <th style="width: 25%;">{{ $data->ESTADOMATERIA}}</th>
            </tr>
            @endforeach
            </tbody>
        </table>
