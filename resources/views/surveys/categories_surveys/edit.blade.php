...
@section('mainContent')
    <div class="col-lg-5">
        {!! Form::open(['route'=>['surveys.categories_surveys.update',$objSurvey],'method'=>'PUT', 'enctype'=>"multipart/form-data"]) !!}
        <div class="panel panel-primary panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title text-bold" style="text-align: center;">EDICI&Oacute;N DE CATEGOR&Iacute;AS</h5>
            </div>
