...
@section('mainContent')
    <div class="col-lg-5">
        {!! Form::open(['route'=> 'surveys.categories_questions.store','method'=>'POST','enctype'=>"multipart/form-data"]) !!}
        <div class="panel panel-primary panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title text-bold" style="text-align: center;">INGRESO DE CATEGOR&Iacute;AS DE PREGUNTAS</h5>
            </div>
