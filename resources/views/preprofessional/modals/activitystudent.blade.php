        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <div class="form-group">
                    {!! Form::label('date','FECHA',["class"=>"text-bold col-lg-3 control-label"]) !!}
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                       {!! Form::label('n_hours','N° HORAS',["class"=>"text-bold col-lg-3 control-label"]) !!}
                        <div class="col-lg-9">
                            {!! Form::select('n_hours',Config::get('dataselects.horasActividad'),null,["class"=>"from-control select2" ,"id"=>"n_hours"]) !!}
                        </div>
                ...
                <div class="form-group">
                        {!! Form::label('description','DESCRIPCIÓN',["class"=>"text-bold col-lg-3 control-label"]) !!}
                        <div class="col-lg-9">
                ...
                <div class="form-group">
                        {!! Form::label('observation','OBSERVACIÓN',["class"=>"text-bold col-lg-3 control-label"]) !!}
                        <div class="col-lg-9">
                ...
                <div class="form-group">
                    {!! Form::label('anexo','ANEXOS',["class"=>"text-bold col-lg-3 control-label"]) !!}
                    <div class="col-lg-9">
