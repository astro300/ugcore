...
@section('mainContent')
    <div class="col-lg-5">
        {!! Form::open(['route'=> 'admin.catalogos.autoridades.store',
        'method'=>'POST']) !!}
        <div class="panel panel-primary panel-flat">
            ...
            <div class="panel-body">
                <div class="col-lg-12">
                    {!! Field::text('nombres',null,['label'=>'Nombres:','required'=>true]) !!}
                </div>
                <div class="col-lg-6">
                    {!! Field::text('nuic',null,['label'=>'Identificaci&oacute;n:','required'=>true]) !!}

                </div>
                <div class="col-lg-6">
                    {!! Field::text('email',null,['label'=>'Email:','required'=>true]) !!}

                </div>

                <div class="col-lg-12">
                    {!! Field::select('tipoAutoridad',Config::get('dataselects.tipoAutoridad'),null,
                    ['label'=>'Tipo Autoridad:','required'=>true,"class"=>"select2",'empty'=>'SELECCIONE' ]) !!}
                </div>
                <div class="col-lg-12">
                    {!! Field::select('facultad',$facultades,null,
                               ['label'=>'Facultad:','required'=>true,"class"=>"select2",'empty'=>'SELECCIONE' ]) !!}
                    {!! Field::select('carrera',[],null,
