...
(function (l) {
    ...
    (function (f) {
        var l = f.defaultOptions, n = f.doc, A = f.Chart, v = f.addEvent, G = f.removeEvent, D = f.fireEvent, q = f.createElement, B = f.discardElement, w = f.css, p = f.merge, C = f.pick, m = f.each, t = f.extend, H = f.isTouchDevice, E = f.win, I = f.Renderer.prototype.symbols;
        t(l.lang, {
        ...
        f.post = function (a, b, e) {
            ...
            for (d in b)q("input", {type: "hidden", name: d, value: b[d]}, null, a);
            a.submit();
            B(a)
        };
        t(A.prototype, {
            sanitizeSVG: function (a, b) {
                ...
                var b = this, e, d, g, u, h, c = p(b.options, a);
                ...
                t(c.chart, {animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: g, height: h});
                ...
                var a = this, b = a.container, e = [], d = b.parentNode, g = n.body, f = g.childNodes, h = a.options.exporting.printMaxWidth, c, F;
                if (!a.isPrinting) {
                    a.isPrinting = !0;
                ...
                var c = this, g = c.options.navigation, l = c.chartWidth, r = c.chartHeight, p = "cache-" + a, k = c[p], x = Math.max(f, u), y, z;
                k || (c[p] = k = q("div", {className: a}, {
                    position: "absolute",
                    zIndex: 1E3,
                    padding: x + "px"
                }, c.container), y = q("div", {className: "highcharts-menu"},
                    null, k), w(y, t({
                    ...
                    if (a) {
                        ...
                        }, w(b, t({cursor: "pointer"}, g.menuItemStyle)));
                ...
                var b = this, e = b.renderer, d = p(b.options.navigation.buttonOptions, a), f = d.onclick, l = d.menuItems, h, c, m = d.symbolSize || 12;
                b.btnCount || (b.btnCount = 0);
                b.exportDivElements || (b.exportDivElements = [], b.exportSVGElements = []);
                if (!1 !== d.enabled) {
                    var n = d.theme, r = n.states, q = r && r.hover, r = r && r.select, k;
                    delete n.states;
                    f ? k = function (a) {
                        a.stopPropagation();
                        f.call(b, a)
                    ...
                    d.symbol && (h = e.symbol(d.symbol, d.symbolX - m / 2, d.symbolY - m / 2, m, m).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(c), h.attr({
                        stroke: d.symbolStroke,
                        fill: d.symbolFill, "stroke-width": d.symbolStrokeWidth || 1
                    }));
                    c.add().align(t(d, {width: c.width, x: C(d.x, b.buttonOffset)}), !0, "spacingBox");
        ...
        A.prototype.renderExporting = function () {
            var a, b = this.options.exporting, e = b.buttons, d = this.isDirtyExporting || !this.exportSVGElements;
            this.buttonOffset = 0;
