/**
 * Created by eliberio on 05/12/16.
 */
/*
...
(function (M, a) {
    ...
    M = function () {
        var a = window, E = a.document, A = a.navigator && a.navigator.userAgent || "", F = E && E.createElementNS && !!E.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, H = /(edge|msie|trident)/i.test(A) && !window.opera, p = !F, d = /Firefox/.test(A), g = d && 4 > parseInt(A.split("Firefox/")[1], 10);
    ...
    (function (a) {
        var E = [], A = a.charts, F = a.doc, H = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], d = this.paths[1], g = [], v = this.now, l = a.length, r;
                if (1 === v)g = this.toD; else if (l === d.length && 1 > v)for (; l--;)r = parseFloat(a[l]), g[l] = isNaN(r) ? a[l] : v * parseFloat(d[l] - r) + r; else g = d;
                this.elem.attr("d", g, null, !0)
            }, update: function () {
                var a = this.elem, d = this.prop, g = this.now, v = this.options.step;
                if (this[d + "Setter"])this[d +
                "Setter"](); else a.attr ? a.element && a.attr(d, g, null, !0) : a.style[d] = g + this.unit;
                v && v.call(a, g, this)
            }, run: function (a, d, g) {
                var p = this, l = function (a) {
                ...
                var d = +new Date, g, p = this.options;
                g = this.elem;
                var l = p.complete, r = p.duration, f = p.curAnim, b;
                if (g.attr && !g.element)g = !1; else if (a || d >= r + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                    a = f[this.prop] = !0;
                ...
                d = d || "";
                var f, b = a.startX, n = a.endX, w = -1 < d.indexOf("C"), t = w ? 7 : 3, k, e, h;
                d = d.split(" ");
                g = g.slice();
                var C = a.isArea, u = C ? 2 : 1, c;
                w && (p(d), p(g));
                if (b && n) {
                    for (h = 0; h < b.length; h++)if (b[h] === n[0]) {
                        f = h;
                        break
        ...
        a.attr = function (p, d, g) {
            var v, l;
            if (a.isString(d))a.defined(g) ? p.setAttribute(d, g) : p && p.getAttribute && (l = p.getAttribute(d)); else if (a.defined(d) && a.isObject(d))for (v in d)p.setAttribute(v, d[v]);
            return l
        };
        a.splat = function (p) {
        ...
        a.pick = function () {
            var a = arguments, d, g, v = a.length;
            for (d = 0; d < v; d++)if (g =
        ...
        a.dateFormat = function (p, d, g) {
            ...
            var v = a.Date, l = new v(d - a.getTZOffset(d)), r, f = l[v.hcGetHours](), b = l[v.hcGetDay](), n = l[v.hcGetDate](), w = l[v.hcGetMonth](), t = l[v.hcGetFullYear](), k = a.defaultOptions.lang, e = k.weekdays, h = k.shortWeekdays, C = a.pad, v = a.extend({
            ...
            for (r in v)for (; -1 !== p.indexOf("%" + r);)p = p.replace("%" + r, "function" === typeof v[r] ? v[r](d) : v[r]);
            return g ? p.substr(0, 1).toUpperCase() + p.substr(1) : p
        };
        a.formatSingle = function (p, d) {
            var g = /\.([0-9])/, v = a.defaultOptions.lang;
        ...
        a.removeEvent = function (p, d, g) {
            ...
            function l() {
                var a, b;
                if (p.nodeName)for (b in d ? (a = {}, a[d] = !0) : a = f, a)if (f[b])for (a = f[b].length; a--;)v(b, f[b][a])
            }
        ...
        a.fireEvent = function (p, d, g, v) {
            ...
            var r, f;
            g = g || {};
            if (F.createEvent && (p.dispatchEvent || p.fireEvent))l = F.createEvent("Events"), l.initEvent(d, !0, !0), a.extend(l, g), p.dispatchEvent ? p.dispatchEvent(l) : p.fireEvent(d, l); else if (l)for (l = l[d] || [], r = l.length, g.target || a.extend(g, {
        ...
        a.animate = function (p, d, g) {
            var v, l = "", r, f, b;
            a.isObject(g) || (v = arguments, g = {duration: v[2], easing: v[3], complete: v[4]});
        ...
        a.seriesType = function (p, d, g, v, l) {
            ...
            f[p] = a.extendClass(f[d] || function () {
                }, v);
        ...
        Array.prototype.forEach || (a.each = function (a, d, g) {
            for (var v = 0, l = a.length; v < l; v++)if (!1 === d.call(g, a[v], v, a))return v
        });
    ...
    (function (a) {
        var E = a.each, A = a.isNumber, F = a.map, H = a.merge, p = a.pInt;
        a.Color = function (d) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                }); else for (l = this.parsers.length; l-- && !v;)r = this.parsers[l], (g = r.regex.exec(d)) && (v = r.parse(g));
                this.rgba = v || []
            }, get: function (a) {
                ...
                if (this.stops)E(this.stops, function (l) {
                    l.brighten(a)
                }); else if (A(a) && 0 !== a)for (d = 0; 3 > d; d++)v[d] += p(255 * a), 0 > v[d] && (v[d] = 0), 255 < v[d] && (v[d] = 255);
                return this
    ...
    (function (a) {
        var E, A, F = a.addEvent, H = a.animate, p = a.attr, d = a.charts, g = a.color, v = a.css, l = a.createElement, r = a.defined, f = a.deg2rad, b = a.destroyObjectProperties, n = a.doc, w = a.each,
            t = a.extend, k = a.erase, e = a.grep, h = a.hasTouch, C = a.isArray, u = a.isFirefox, c = a.isMS, q = a.isObject, x = a.isString, K = a.isWebKit, I = a.merge, J = a.noop, D = a.pick, G = a.pInt, L = a.removeEvent, N = a.stop, m = a.svg, z = a.SVG_NS, O = a.symbolSizes, P = a.win;
        ...
        E.prototype = {
            ...
            colorGradient: function (y, B, c) {
                var m = this.renderer, b, e, z, q, k, Q, h, f, x, n, t, u = [], D;
                ...
                if (e) {
                    ...
                    h = y.stops;
                    n = c.radialReference;
                    C(z) && (y[e] = z = {x1: z[0], y1: z[1], x2: z[2], y2: z[3], gradientUnits: "userSpaceOnUse"});
                    "radialGradient" === e && n && !r(z.gradientUnits) && (q = z, z = I(z, m.getRadialAttr(n,
                        q), {gradientUnits: "userSpaceOnUse"}));
                    ...
                    k[u] ? n = k[u].attr("id") : (z.id = n = a.uniqueKey(), k[u] = Q = m.createElement(e).attr(z).add(m.defs), Q.radAttr = q, Q.stops = [], w(h, function (y) {
                        ...
                        y = m.createElement("stop").attr({offset: y[0], "stop-color": f, "stop-opacity": x}).add(Q);
                        Q.stops.push(y)
                    }));
                    D = "url(" + m.url + "#" + n + ")";
                    c.setAttribute(B, D);
            ...
            attr: function (a, B, c, m) {
                var y, b = this.element, e, z = this, q;
                "string" === typeof a && void 0 !== B && (y = a, a = {}, a[y] = B);
                if ("string" === typeof a)z = (this[a + "Getter"] || this._defaultGetter).call(this, a, b); else {
            ...
            css: function (a) {
                var y = this.styles, b = {}, e = this.element, z, q, k = "";
                z = !y;
            ...
            updateTransform: function () {
                var a = this.translateX || 0, B = this.translateY || 0, c = this.scaleX, m = this.scaleY, b = this.inverted, e = this.rotation, z = this.element;
            ...
            getBBox: function (a, B) {
                var y, m = this.renderer, b, e = this.element, z = this.styles, q, k = this.textStr, h, x = m.cache, n = m.cacheKeys, u;
                B = D(B, this.rotation);
                b = B * f;
                q = z && z.fontSize;
                void 0 !==
            ...
            add: function (a) {
                var y = this.renderer, c = this.element, m;
            ...
            destroy: function () {
                var a = this.element || {}, c = this.renderer.isSVG && "SPAN" === a.nodeName && this.parentGroup, m, b;
            ...
            shadow: function (a, c, m) {
                var y = [], B, b, e = this.element, z, q, k, h;
            ...
            zIndexSetter: function (a, c) {
                var m = this.renderer, y = this.parentGroup, b = (y || m).element || m.box, B, e = this.element, z;
                B = this.added;
                var q;
        ...
        A.prototype = {
            Element: E, SVG_NS: z, init: function (a, c, m, b, e, z) {
                ...
                c.init(this, a);
                return c
            }, draw: J, getRadialAttr: function (a, c) {
                ...
                k || r || K || C || -1 !== q.indexOf(" ") ? (x = /<.*class="([^"]+)".*>/, f = /<.*style="([^"]+)".*>/, t = /<.*href="(http[^"]+)".*>/, L && L.appendChild(c), q = k ? q.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g,
                    ...
                    w(q, function (e) {
                        if ("" !== e || 1 === q.length) {
                            ...
                            t.test(e) && !y && (p(D,
                                "onclick", 'location.href\x3d"' + e.match(t)[1] + '"'), v(D, {cursor: "pointer"}));
                            ...
                            if (" " !== e) {
                                ...
                                p(D, h);
                                c.appendChild(D);
                                !k && B && (!m && y && v(D, {display: "block"}), p(D, "dy", P(D)));
                                if (C) {
                                    h = e.replace(/([^\^])-/g, "$1- ").split(" ");
                                    G = "nowrap" === d.whiteSpace;
                                    for (var Q = 1 < q.length || B || 1 < h.length && !G, r, I, w = [], L = P(D), S = a.rotation, O = e, R = O.length; (Q || K) && (h.length || w.length);)a.rotation =
                ...
                var B = this.label(a, m, b, x, null, null, null, null, "button"), y = 0;
                ...
                n = q.style;
                delete q.style;
                h = I(z, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, h);
                u = h.style;
                delete h.style;
                ...
                a = this.symbol("arc", a || 0, c || 0, m || 0, m || 0, {innerR: b || 0, start: e || 0, end: z || 0});
                a.r = m;
                return a
            ...
            setSize: function (a, c, m) {
                ...
                1 < arguments.length && t(z, {x: c, y: m, width: b, height: e});
                ...
                var q = this, B, y = this.symbols[a], h = r(c) && y && y(Math.round(c), Math.round(m), b, e, z), k = /^url\((.*?)\)$/, x, f;
                y ? (B = this.path(h), B.attr("fill", "none"), t(B, {
                    ...
                    B[a + "Setter"] = function (a, c) {
                        var m = {}, b = this["img" + c], e = "width" === c ? "translateX" : "translateY";
                        this[c] = a;
                    ...
                    x: c,
                    y: m
                }), B.isImg = !0, r(B.imgwidth) && r(B.imgheight) ? f() : (B.attr({width: 0, height: 0}), l("img", {
                    onload: function () {
                        var a = d[q.chartIndex];
                        0 === this.width && (v(this, {position: "absolute", top: "-999em"}),
                ...
                circle: function (a, c, m, b) {
                    ...
                    var q = e.end - .001;
                    b = e.innerR;
                    var B = e.open, h = Math.cos(z), k = Math.sin(z), y = Math.cos(q), q = Math.sin(q);
                    ...
                    var z =
                        Math.min(e && e.r || 0, m, b), q = z + 6, B = e && e.anchorX;
                    e = e && e.anchorY;
                    var h;
                ...
                var z = a.uniqueKey(), q = this.createElement("clipPath").attr({id: z}).add(this.defs);
                ...
                e || (a.xSetter = function (a, c, m) {
                    var b = m.getElementsByTagName("tspan"), e, z = m.getAttribute(c), q;
                ...
                var B = this, x = B.g("button" !== k && "label"), f = x.text = B.text("", 0, 0, q).attr({zIndex: 1}), n, u, D = 0, y = 3, l = 0, G, d, C, g, K, P = {}, O, v, N = /^url\((.*?)\)$/.test(b), Q = N, J, p, S, R;
                ...
                S = function () {
                    var a = l + y, c;
                    c = h ? 0 : v;
                    r(G) && u && ("center" === K || "right" === K) && (a += {center: .5, right: 1}[K] * (G - u.width));
                ...
                return t(x, {
                    css: function (a) {
                        ...
                        return {width: u.width + 2 * y, height: u.height + 2 * y, x: u.x - y, y: u.y - y}
                    }, shadow: function (a) {
                        a && (p(), n && n.shadow(a));
                        return x
                    }, destroy: function () {
    ...
    (function (a) {
        var E = a.attr, A = a.createElement, F = a.css, H = a.defined, p = a.each, d = a.extend, g = a.isFirefox, v = a.isMS, l = a.isWebKit, r = a.pInt, f =
            a.SVGRenderer, b = a.win, n = a.wrap;
        d(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a =
                        this.renderer, b = this.element, k = this.translateX || 0, e = this.translateY || 0, h = this.x || 0, f = this.y || 0, n = this.textAlign || "left", c = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[n], q = this.styles;
                    ...
                    if ("SPAN" === b.tagName) {
                        var x = this.rotation, d = r(this.textWidth), g = q && q.whiteSpace, v = [x, n, b.innerHTML, this.textWidth, this.textAlign].join();
                ...
                var e = {}, h = v ? "-ms-transform" : l ? "-webkit-transform" : g ? "MozTransform" : b.opera ? "-o-transform" : "";
                e[h] = e.transform =
                    "rotate(" + a + "deg)";
        ...
        d(f.prototype, {
            html: function (a, b, k) {
                var e = this.createElement("span"), h = e.element, f = e.renderer, u = f.isSVG, c = function (a, c) {
    ...
    (function (a) {
        var E, A, F = a.createElement, H = a.css, p = a.defined, d = a.deg2rad, g = a.discardElement, v = a.doc, l = a.each, r = a.erase, f = a.extend;
        E = a.extendClass;
        var b = a.isArray, n = a.isNumber, w = a.isObject, t = a.merge;
        A = a.noop;
        var k = a.pick, e = a.pInt, h = a.SVGElement, C = a.SVGRenderer, u = a.win;
        a.svg || (A = {
            ...
            updateTransform: h.prototype.htmlUpdateTransform, setSpanRotation: function () {
                ...
                var c = h ? Math.cos(h * d) : 1, q = h ? Math.sin(h * d) : 0, x = k(this.elemHeight, this.element.offsetHeight), n;
                this.xCorr = 0 > c && -a;
                this.yCorr = 0 > q && -x;
                n = 0 > c * q;
                this.xCorr += q * b * (n ? 1 -
                ...
                f && "left" !== f && (this.xCorr -= a * e * (0 > c ? -1 : 1), h && (this.yCorr -= x * e * (0 > q ? -1 : 1)), H(this.element, {textAlign: f}))
            ...
            shadow: function (a, b, h) {
                var c = [], q, f = this.element, n = this.renderer, x, u = f.style, d, m = f.path, z, l, t, y;
            ...
            }, opacitySetter: A, rotationSetter: function (a,
                                                           b, e) {
                e = e.style;
                this[b] = e[b] = a;
            ...
            Element: A, isIE8: -1 < u.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a,
                ...
                var c = this.createElement(), q = w(a);
                return f(c, {
                    members: [],
                    count: 0,
                    left: (q ? a.x : a) + 1,
                ...
                var q = this, k, f = /^rgba/, n, u, x = "none";
                c && c.linearGradient ? u = "gradient" : c && c.radialGradient && (u = "pattern");
                if (u) {
                    var m, z, d = c.linearGradient || c.radialGradient, t, y, B, C, g, r = "";
                    c = c.stops;
                    var w, v = [], K = function () {
                    ...
                    if ("fill" === e)if ("gradient" === u)e = d.x1 || d[0] || 0, c = d.y1 || d[1] || 0, t = d.x2 || d[2] || 0, d = d.y2 || d[3] || 0, r = 'angle\x3d"' + (90 - 180 * Math.atan((d - c) / (t - e)) / Math.PI) + '"',
                        K(); else {
                        var x = d.r, p = 2 * x, A = 2 * x, E = d.cx, H = d.cy, U = b.radialReference, T, x = function () {
                ...
                return a
            }, text: C.prototype.html, path: function (a) {
                ...
                arc: function (a, b, e, h, k) {
                    ...
                    e = k.innerR;
                    h = Math.cos(c);
                    var n = Math.sin(c), u = Math.cos(f), m = Math.sin(f);
                    if (0 === f - c)return ["x"];
    ...
    (function (a) {
        function E() {
            var v = a.defaultOptions.global, l, r = v.useUTC, f = r ? "getUTC" : "get", b = r ? "setUTC" : "set";
        ...
        var A = a.color, F = a.each, H = a.getTZOffset, p = a.merge, d = a.pick, g = a.win;
        a.defaultOptions = {
            ...
            global: {useUTC: !0, VMLRadialGradientURL: "http://code.highcharts.com/5.0.5/gfx/vml-radial-gradient.png"},
            chart: {
                borderRadius: 0,
    ...
    (function (a) {
        var E = a.arrayMax, A = a.arrayMin, F = a.defined,
            H = a.destroyObjectProperties, p = a.each, d = a.erase, g = a.merge, v = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var a = this, d = a.axis, f = d.horiz, b = a.options, n = b.label, w = a.label, t = b.to, k = b.from, e = b.value, h = F(k) && F(t), C = F(e), u = a.svgElem, c = !u, q = [], x, K = b.color, I = v(b.zIndex, 0), p = b.events, q = {"class": "highcharts-plot-" + (h ? "band " : "line ") + (b.className || "")}, D = {}, G = d.chart.renderer, L = h ? "bands" : "lines", N = d.log2lin;
                d.isLog && (k = N(k), t =
                    N(t), e = N(e));
                C ? (q = {
                    stroke: K,
                ...
                if (C)q = d.getPlotLinePath(e, u.strokeWidth()); else if (h)q = d.getPlotBandPath(k, t, b); else return;
                if (c && q && q.length) {
                    if (u.attr({d: q}), p)for (x in b = function (b) {
                        u.on(b, function (c) {
                            p[b].apply(a, [c])
                        })
                    }, p)b(x)
                } else u &&
                (q ? (u.show(), u.animate({d: q})) : (u.hide(), w && (a.label = w = w.destroy())));
    ...
    (function (a) {
        var E = a.correctFloat, A = a.defined, F = a.destroyObjectProperties, H = a.isNumber, p = a.merge, d = a.pick, g = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, g = a.options, r = a.chart, f = a.categories, b = a.names, n = this.pos, w = g.labels, t = a.tickPositions, k = n === t[0], e = n === t[t.length - 1], b = f ? d(f[n],
                    b[n], n) : n, f = this.label, t = t.info, h;
                ...
                var l = this.axis, r = a.x, f = l.chart.chartWidth, b = l.chart.spacing, n = d(l.labelLeft, Math.min(l.pos, b[3])), b = d(l.labelRight, Math.max(l.pos + l.len, f - b[1])), w = this.label, t = this.rotation, k = {
                    left: 0,
                    center: .5,
                    right: 1
                }[l.labelAlign], e = w.getBBox().width, h = l.getSlotWidth(), C = h, u = 1, c, q = {};
                if (t)0 > t && r - k * e < n ? c = Math.round(r / Math.cos(t * g) - n) : 0 < t && r + k * e > b && (c = Math.round((f - r) / Math.cos(t * g))); else if (f = r + (1 - k) * e, r - k * e < n ? C = a.x + C * (1 - k) - n : f > b && (C = b - a.x + C * k, u = -1), C = Math.min(h,
                ...
                var k = this.axis, e = k.transA, h = k.reversed, C = k.staggerLines, u = k.tickRotCorr || {
                        x: 0,
                        y: 0
                    }, c = b.y;
    ...
    (function (a) {
        ...
        a.Axis.prototype = {
            ...
            defaultLabelFormatter: function () {
                ...
                if (n)d = k(n, this); else if (e)d = c; else if (h)d = a.dateFormat(h, c); else if (q && 1E3 <= b)for (; q-- && void 0 === d;)e = Math.pow(f, q + 1), b >= e && 0 === 10 * c % e && null !== B[q] && 0 !== c && (d = a.numberFormat(c / e, -1) + B[q]);
            ...
            getSeriesExtremes: function () {
                ...
                b(a.series, function (b) {
                    if (b.visible || !e.options.chart.ignoreHiddenSeries) {
                        var m = b.options, z = m.threshold, k;
                        a.hasVisibleSeries = !0;
                        a.isLog && 0 >= z && (z = null);
                        if (a.isXAxis)m = b.xData, m.length && (b = H(m), c(b) || b instanceof Date || (m = h(m, function (a) {
                            return c(a)
                        }), b = H(m)), a.dataMin = Math.min(I(a.dataMin, m[0]), b), a.dataMax = Math.max(I(a.dataMax, m[0]), F(m))); else if (b.getExtremes(), k = b.dataMax, b = b.dataMin, l(b) && l(k) && (a.dataMin = Math.min(I(a.dataMin, b), b), a.dataMax = Math.max(I(a.dataMax, k), k)), l(z) && (a.threshold = z), !m.softThreshold || a.isLog)a.softThreshold = !1
                    }
                })
            },
            translate: function (a, b, e, h, k, B) {
                var m = this.linkedParent || this, z = 1, f = 0, q = h ? m.oldTransA : m.transA;
                h = h ? m.oldMin : m.min;
            ...
            getPlotLinePath: function (a, b, e, h, k) {
                var m = this.chart, z = this.left, f = this.top, q, d, n = e && m.oldChartHeight || m.chartHeight, u = e && m.oldChartWidth || m.chartWidth, g;
                q = this.transB;
            ...
            getLinearTickPositions: function (a, b, e) {
                var m, z = g(Math.floor(b / a) * a), h = g(Math.ceil(e / a) * a), k = [];
                if (b === e && c(b))return [b];
                for (b = z; b <= h;) {
                    k.push(b);
                    b = g(b + a);
            ...
            getMinorTickPositions: function () {
                var a = this.options, b = this.tickPositions, c = this.minorTickInterval, e = [], h, k = this.pointRangePadding || 0;
                h = this.min - k;
                var k = this.max + k, f = k - h;
                if (f && f / c < this.len / 3)if (this.isLog)for (k = b.length, h = 1; h < k; h++)e = e.concat(this.getLogTickPositions(c, b[h - 1], b[h], !0)); else if (this.isDatetimeAxis &&
                    "auto" === a.minorTickInterval)e = e.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), h, k, a.startOfWeek)); else for (b = h + (b[0] - h) % c; b <= k && b !== e[0]; b += c)e.push(b);
                0 !== e.length && this.trimTicks(e, a.startOnTick, a.endOnTick);
                return e
            },
            adjustForMinRange: function () {
                var a = this.options, c = this.min, e = this.max, h, k = this.dataMax - this.dataMin >= this.minRange, f, q, d, n, u, g;
            ...
            nameToX: function (a) {
                var b = u(this.categories), c = b ? this.categories : this.names, e = a.options.x, m;
            ...
            setAxisTranslation: function (a) {
                var c = this, e = c.max - c.min, m = c.axisPointRange || 0, h, k = 0, f = 0, d = c.linkedParent, n = !!c.categories, u = c.transA, g = c.isXAxis;
            ...
            setTickInterval: function (a) {
                var m = this, h = m.chart, k = m.options, f = m.isLog, q = m.log2lin, d = m.isDatetimeAxis, u = m.isXAxis,
                    D = m.isLinked, x = k.maxPadding, C = k.minPadding, G = k.tickInterval, r = k.tickPixelInterval, L = m.categories, w = m.threshold, p = m.softThreshold, v, N, J, A;
            ...
            setTickPositions: function () {
                var a = this.options, b, c = a.tickPositions, e = a.tickPositioner, h = a.startOnTick, k = a.endOnTick, f;
            ...
            trimTicks: function (a, b, c) {
                ...
                if (b)this.min = e; else for (; this.min - h > a[0];)a.shift();
                if (c)this.max = m; else for (; this.max + h < a[a.length - 1];)a.pop();
            ...
            zoom: function (a, b) {
                var c = this.dataMin,
                    e = this.dataMax, m = this.options, h = Math.min(c, I(m.min, c)), m = Math.max(e, I(m.max, e));
                if (a !== this.min || b !== this.max)this.allowZoomOutside || (l(c) && (a < h && (a = h), a > m && (a = m)), l(e) && (b < h && (b = h), b > m && (b = m))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            ...
            getThreshold: function (a) {
                var b =
                    this.isLog, c = this.lin2log, e = b ? c(this.min) : this.min, b = b ? c(this.max) : this.max;
            ...
            tickSize: function (a) {
                var b = this.options, c = b[a + "Length"], e = I(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            unsquish: function () {
                var a = this.options.labels, c = this.horiz, e = this.tickInterval, h = e, k = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), f, q = a.rotation, d = this.labelMetrics(), n, u = Number.MAX_VALUE, g, t = function (a) {
                    a /= k || 1;
                    a = 1 < a ? Math.ceil(a) : 1;
                    return a * e
                };
            ...
            renderUnsquish: function () {
                var a = this.chart, c = a.renderer, e = this.tickPositions, h = this.ticks, k = this.options.labels, f = this.horiz,
                    d = this.getSlotWidth(), n = Math.max(1, Math.round(d - 2 * (k.padding || 5))), u = {}, g = this.labelMetrics(), t = k.style && k.style.textOverflow, D, C = 0, G, l;
                q(k.rotation) || (u.rotation = k.rotation || 0);
                b(e, function (a) {
                    (a = h[a]) && a.labelLength > C && (C = a.labelLength)
                });
                this.maxLabelLength = C;
                if (this.autoRotation)C > n && C > g.h ? u.rotation = this.labelRotation : this.labelRotation = 0; else if (d && (D = {width: n + "px"}, !t))for (D.textOverflow = "clip", G = e.length; !f && G--;)if (l = e[G], n = h[l].label)n.styles && "ellipsis" === n.styles.textOverflow ? n.css({textOverflow: "clip"}) :
                h[l].labelLength > d && n.css({width: d + "px"}), n.getBBox().height > this.len / e.length - (g.h - g.f) && (n.specCss = {textOverflow: "ellipsis"});
                u.rotation && (D = {width: (C > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"}, t || (D.textOverflow = "ellipsis"));
            ...
            getOffset: function () {
                var a = this, c = a.chart, e = c.renderer, h = a.options, k = a.tickPositions, f = a.ticks, q = a.horiz, d = a.side, n = c.inverted ? [1, 0, 3, 2][d] : d, u, g, t = 0, D, x = 0, C = h.title, G = h.labels, r = 0, L = a.opposite, w = c.axisOffset, c = c.clipOffset, p = [-1, 1, 1, -1][d], K, v = h.className, J = a.axisParent, A = this.tickSize("tick");
                u = a.hasData();
                a.showAxis = g = u || I(h.showEmpty, !0);
                a.staggerLines = a.horiz && G.staggerLines;
                a.axisGroup ||
                (a.gridGroup = e.g("grid").attr({zIndex: h.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (v || "")).add(J), a.axisGroup = e.g("axis").attr({zIndex: h.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (v || "")).add(J), a.labelGroup = e.g("axis-labels").attr({zIndex: G.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (v || "")).add(J));
                if (u || a.isLinked)b(k, function (b) {
                    f[b] ? f[b].addLabel() : f[b] = new N(a, b)
                }), a.renderUnsquish(), !1 === G.reserveSpace || 0 !== d && 2 !== d &&
                {1: "left", 3: "right"}[d] !== a.labelAlign && "center" !== a.labelAlign || b(k, function (a) {
                    r = Math.max(f[a].getLabelSize(), r)
                }), a.staggerLines && (r *= a.staggerLines, a.labelOffset = r * (a.opposite ? -1 : 1)); else for (K in f)f[K].destroy(), delete f[K];
            ...
            getLinePath: function (a) {
                var b = this.chart, c = this.opposite, e = this.offset, m = this.horiz, h = this.left + (c ? this.width : 0) + e, e = b.chartHeight - this.bottom - (c ? this.height : 0) + e;
                c && (a *= -1);
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, c = this.top, e = this.len, h = this.options.title, k = a ? b : c, f = this.opposite, q = this.offset, d = h.x || 0, n = h.y || 0, u = this.chart.renderer.fontMetrics(h.style && h.style.fontSize, this.axisTitle).f, e = {
                    low: k + (a ? 0 : e),
                    middle: k + e / 2,
                    high: k + (a ? e : 0)
                }[h.align], b = (a ? c + this.height : b) + (a ? 1 : -1) * (f ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? u : 0);
                return {
            ...
            render: function () {
                var a =
                    this, e = a.chart, h = e.renderer, k = a.options, f = a.isLog, q = a.lin2log, d = a.isLinked, n = a.tickPositions, u = a.axisTitle, g = a.ticks, t = a.minorTicks, D = a.alternateBands, C = k.stackLabels, x = k.alternateGridColor, G = a.tickmarkOffset, l = a.axisLine, r = e.hasRendered && c(a.oldMin), w = a.showAxis, I = A(h.globalAnimation), p, K;
            ...
            drawCrosshair: function (a, b) {
                var c, e = this.crosshair, h = I(e.snap, !0), k, m = this.cross;
                ...
                m || (this.cross = m = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + e.className).attr({zIndex: I(e.zIndex, 2)}).add(), m.attr({
    ...
    (function (a) {
        var E = a.Axis, A = a.Date, F = a.dateFormat, H = a.defaultOptions, p = a.defined, d = a.each, g = a.extend, v = a.getMagnitude, l = a.getTZOffset, r = a.normalizeTickInterval, f = a.pick, b = a.timeUnits;
        E.prototype.getTimeTicks = function (a, r, t, k) {
            var e = [], h = {}, n = H.global.useUTC, u, c = new A(r - l(r)), q = A.hcMakeTime, x = a.unitRange, w = a.count, I;
            if (p(r)) {
    ...
    (function (a) {
        var E = a.Axis,
            A = a.getMagnitude, F = a.map, H = a.normalizeTickInterval, p = a.pick;
        E.prototype.getLogTickPositions = function (a, g, v, l) {
            ...
            if (.5 <= a)a = Math.round(a), w = this.getLinearTickPositions(a, g, v); else if (.08 <= a)for (var f = Math.floor(g), t, k, e, h, C, d = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < v + 1 && !C; f++)for (k = d.length, t = 0; t < k && !C; t++)e = n(b(f) * d[t]), e > g && (!l || h <= v) && void 0 !== h && w.push(h), h > v && (C = !0), h = e; else g = b(g), v =
    ...
    (function (a) {
        var E = a.dateFormat, A = a.each, F = a.extend, H = a.format, p = a.isNumber, d = a.map, g =
            a.merge, v = a.pick, l = a.splat, r = a.syncTimeout, f = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            init: function (a, f) {
                ...
                var b = this, e = b.now, h = !1 !== b.options.animation && !b.isHidden && (1 < Math.abs(a - e.x) || 1 < Math.abs(f - e.y)), n = b.followPointer || 1 < b.len;
                F(e, {
                    x: h ? (2 * e.x + a) / 3 : a,
                    y: h ? (e.y + f) / 2 : f,
                ...
                var b, n = this.chart, k = n.inverted, e = n.plotTop, h = n.plotLeft, g = 0, u = 0, c, q;
                a = l(a);
                b = a[0].tooltipPos;
                ...
                var b = this.chart, k = this.distance, e = {}, h = d.h || 0, n, u = ["y", b.chartHeight, f, d.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight], c = ["x", b.chartWidth, a, d.plotX + b.plotLeft, b.plotLeft, b.plotLeft + b.plotWidth], q = !this.followPointer && v(d.ttBelow, !b.inverted === !!d.negative), g = function (a, b, c, f, m, d) {
                    var n = c < f - k, u = f + k + c < b, g =
                        f - k - c;
                    f += k;
                    if (q && u)e[a] = f; else if (!q && n)e[a] = g; else if (n)e[a] = Math.min(d - c, 0 > g - h ? g : g - h); else if (u)e[a] = Math.max(m, f + h + c > b ? f : f + h); else return !1
                }, l = function (a, b, c, h) {
                    var m;
                ...
                var b = this.chart, d, k = this.options, e, h, n = {}, u = [];
                ...
                !1 === n ? this.hide() : (d = this.getLabel(), this.isHidden && d.attr({opacity: 1}).show(), this.split ? this.renderSplit(n, b.hoverPoints) : (d.attr({text: n && n.join ? n.join("") : n}), d.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + v(a.colorIndex, c.colorIndex)), d.attr({stroke: k.borderColor || a.color || c.color || "#666666"}), this.updatePosition({
                    plotX: f, plotY: e,
                    negative: a.negative, ttBelow: a.ttBelow, h: h[2] || 0
                })), this.isHidden = !1)
            }, renderSplit: function (b, f) {
                var d = this, n = [], k = this.chart, e = k.renderer, h = !0, g = this.options, u, c = this.getLabel();
                A(b.slice(0, b.length - 1), function (a, b) {
                    b = f[b - 1] || {isHeader: !0, plotX: f[0].plotX};
                    var q = b.series || d, t = q.tt, x = b.series || {}, D = "highcharts-color-" + v(b.colorIndex, x.colorIndex, "none");
                ...
                var b = this.chart, f = this.getLabel(), f = (this.options.positioner || this.getPosition).call(this, f.width, f.height, a);
                this.move(Math.round(f.x), Math.round(f.y || 0), a.plotX + b.plotLeft, a.plotY + b.plotTop)
            },
            getXDateFormat: function (a, d, g) {
                var b;
                d = d.dateTimeLabelFormats;
                var k = g && g.closestPointRange, e, h = {
                    millisecond: 15,
                    second: 12,
                    minute: 9,
                    hour: 6,
                ...
                var b =
                    f ? "footer" : "header";
                f = a.series;
                var d = f.tooltipOptions, k = d.xDateFormat, e = f.xAxis, h = e && "datetime" === e.options.type && p(a.key), b = d[b + "Format"];
    ...
    (function (a) {
        var E = a.addEvent, A = a.attr, F = a.charts, H = a.color, p = a.css, d =
            a.defined, g = a.doc, v = a.each, l = a.extend, r = a.fireEvent, f = a.offset, b = a.pick, n = a.removeEvent, w = a.splat, t = a.Tooltip, k = a.win;
        ...
        a.Pointer.prototype = {
            init: function (a, h) {
                ...
                var h = this.chart, f = h.series, k = h.tooltip, c = k ? k.shared : !1, d = !0, n = h.hoverPoint, t = h.hoverSeries, l, r, D, G = [], L;
                if (!c && !t)for (l = 0; l < f.length; l++)if (f[l].directTouch || !f[l].options.stickyTracking)f = [];
                ...
                (f = [t]), v(f, function (a) {
                    ...
                    var e = a.distX - b.distX, h = a.dist - b.dist, k = b.series.group.zIndex - a.series.group.zIndex;
                    return 0 !== e && c ? e : 0 !== h ? h : 0 !== k ? k : a.series.index > b.series.index ? -1 : 1
                }));
                if (c)for (l = G.length; l--;)(G[l].x !== G[0].x || G[l].series.noSharedTooltip) && G.splice(l, 1);
                ...
                var e = this.chart, h = e.hoverSeries, c = e.hoverPoint, k = e.hoverPoints, f = e.tooltip, d = f && f.shared ? k : c;
                ...
                var b = this.chart, e = b.options.chart, k = a.chartX, c = a.chartY, f = this.zoomHor, d = this.zoomVert, g = b.plotLeft, n = b.plotTop, t = b.plotWidth, D = b.plotHeight, l, r = this.selectionMarker, p = this.mouseDownX, m = this.mouseDownY, z = e.panKey && a[e.panKey + "Key"];
                ...
                var b = this, e = this.chart, k = this.hasPinched;
                if (this.selectionMarker) {
                    var c =
                    {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, f = this.selectionMarker, g = f.attr ? f.attr("x") : f.x, n = f.attr ? f.attr("y") : f.y, t = f.attr ? f.attr("width") : f.width, w = f.attr ? f.attr("height") : f.height, D;
                    if (this.hasDragged || k)v(e.axes, function (e) {
                        if (e.zoomEnabled && d(e.min) && (k || b[{xAxis: "zoomX", yAxis: "zoomY"}[e.coll]])) {
                            var f = e.horiz, h = "touchend" === a.type ? e.minPixelPadding : 0, m = e.toValue((f ? g : n) + h), f = e.toValue((f ? g + t : n + w) - h);
                            c[e.coll].push({axis: e, min: Math.min(m, f), max: Math.max(m, f)});
                            D = !0
                        }
    ...
    (function (a) {
        var E = a.charts, A = a.each, F = a.extend, H = a.map, p = a.noop, d = a.pick;
        F(a.Pointer.prototype, {
            pinchTranslate: function (a, d, l, r, f, b) {
                ...
                var g = this.chart, k = a ? "x" : "y", e = a ? "X" : "Y", h = "chart" +
                    e, v = a ? "width" : "height", u = g["plot" + (a ? "Left" : "Top")], c, q, x = p || 1, w = g.inverted, I = g.bounds[a ? "h" : "v"], J = 1 === d.length, D = d[0][h], G = l[0][h], L = !J && d[1][h], N = !J && l[1][h], m;
                l = function () {
                ...
                var g = this, l = g.chart, r = g.pinchDown, f = a.touches, b = f.length, n = g.lastValidTouch, w = g.hasZoom, t = g.selectionMarker, k = {}, e = 1 === b && (g.inClass(a.target, "highcharts-tracker") && l.runTrackerClick || g.runChartClick), h = {};
                1 < b && (g.initiated = !0);
                ...
                "touchstart" === a.type ? (A(f, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b =
                            l.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding, e = a.toPixels(d(a.options.min, a.dataMin)), f = a.toPixels(d(a.options.max, a.dataMax)), k = Math.max(e, f);
    ...
    (function (a) {
        var E = a.addEvent, A = a.charts, F = a.css, H = a.doc, p = a.extend, d = a.noop, g = a.Pointer, v = a.removeEvent, l = a.win, r = a.wrap;
    ...
    (function (a) {
        var E, A = a.addEvent, F = a.css, H = a.discardElement, p = a.defined, d = a.each, g = a.extend, v = a.isFirefox, l = a.marginNames, r = a.merge, f = a.pick, b = a.setAnimation, n = a.stableSort, w = a.win, t = a.wrap;
        ...
        E.prototype =
        {
            ...
            var e = this.options, f = a.legendItem, k = a.legendLine, c = a.legendSymbol, d = this.itemHiddenStyle.color, e = b ? e.itemStyle.color : d, g = b ? a.color || d : d, n = a.options && a.options.marker, l = {fill: g}, t;
            ...
            var b = this.options, f = b.symbolPadding, b = !b.rtl, k = a._legendItemPos, d = k[0], k = k[1], c = a.checkbox;
            ...
            var b = this.group && this.group.alignAttr, f, k = this.clipHeight || this.legendHeight, g = this.titleHeight;
            ...
            var b = this.chart, h = b.renderer, k = this.options, d = "horizontal" === k.layout, c = this.symbolWidth,
                g = k.symbolPadding, n = this.itemStyle, l = this.itemHiddenStyle, t = this.padding, p = d ? f(k.itemDistance, 20) : 0, D = !k.rtl, G = k.width, L = k.itemMarginBottom || 0, w = this.itemMarginTop, m = this.initialItemX, z = a.legendItem, v = !a.series, P = !v && a.series.drawLegendSymbol ? a.series : a, y = P.options, y = this.createCheckboxForItem && y && y.showCheckbox, B = k.useHTML;
            z || (a.legendGroup = h.g("legend-item").addClass("highcharts-" + P.type + "-series highcharts-color-" + a.colorIndex + (a.options.className ? " " + a.options.className : "") + (v ? " highcharts-series-" +
                a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = z = h.text("", D ? c + g : -g, this.baseline || 0, B).css(r(a.visible ? n : l)).attr({
                align: D ? "left" : "right",
                zIndex: 2
            ...
            var e = this.chart, k = this.options, g = k.align.charAt(0) + k.verticalAlign.charAt(0) + k.layout.charAt(0);
            ...
            var a = this, b = a.chart, f = b.renderer, l = a.group, u, c, q, t, r = a.box, p = a.options, w = a.padding;
            ...
            var b = this, h = this.chart, k = h.renderer, g = this.options, c = g.y, h = h.spacingBox.height + ("top" === g.verticalAlign ? -c : c) - this.padding, c = g.maxHeight, n, l = this.clipRect, t = g.navigation, r = f(t.animation, !0), p = t.arrowSize || 12, D = this.nav, G = this.pages, L = this.padding,
                w, m = this.allItems, z = function (a) {
            ...
            a > h && !1 !== t.enabled ? (this.clipHeight = n = Math.max(h - 20 - this.titleHeight - L, 0), this.currentPage = f(this.currentPage, 1), this.fullHeight = a, d(m, function (a, b) {
                ...
                c !== w && (w = c)
            }), l || (l = b.clipRect = k.clipRect(0, L, 9999, 0), b.contentGroup.clip(l)), z(n), D || (this.nav = D = k.g().attr({zIndex: 1}).add(this.group), this.up = k.symbol("triangle", 0, 0, p, p).on("click", function () {
                b.scroll(-1, r)
                ...
                b.scroll(0), a = h) : D && (z(), D.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
            return a
        }, scroll: function (a, e) {
            ...
            0 < a && (void 0 !== e && b(e, this.chart), this.nav.attr({
                ...
                visibility: "visible"
            }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), g.attr({
                text: a + "/" +
                d
            }), this.down.attr({
                x: 18 + this.pager.getBBox().width,
                "class": a === d ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
            }), this.up.attr({fill: 1 === a ? c.inactiveColor : c.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === d ? c.inactiveColor : c.activeColor}).css({cursor: a === d ? "default" : "pointer"}), e = -f[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: e}), this.currentPage = a, this.positionCheckboxes(e))
        }
        };
        a.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                var e =
                    a.options, d = e.symbolHeight || a.fontMetrics.f, e = e.squareSymbol;
                ...
                var b = this.options, f = b.marker, d = a.symbolWidth, k = this.chart.renderer, c = this.legendGroup;
    ...
    (function (a) {
        ...
        y.prototype = {
            callbacks: [], getArgs: function () {
                ...
                var c = this.axes, e = this.series, f = this.pointer, d = this.legend, m = this.isDirtyLegend, h, g, q = this.hasCartesianSeries, l = this.isDirtyBox, D = e.length, u = D, B = this.renderer, r = B.isHidden(), G = [];
                a.setAnimation(b,
                    this);
                r && this.cloneRenderTo();
                for (this.layOutTitles(); u--;)if (b = e[u], b.options.stacking && (h = !0, b.isDirty)) {
                    g = !0;
                    break
                }
                if (g)for (u = D; u--;)b = e[u], b.options.stacking && (b.isDirty = !0);
                n(e, function (a) {
                ...
                for (e = 0; e < c.length; e++)if (c[e].options.id ===
                    a)return c[e];
                ...
                d = f.title = K({style: {color: "#333333", fontSize: f.isStock ? "16px" : "18px"}}, f.title, a);
                f = f.subtitle = K({style: {color: "#666666"}}, f.subtitle, b);
                ...
                n(["title", "subtitle"], function (a) {
                    ...
                    c && (m = d.style.fontSize, m = e.fontMetrics(m, c).b, c.css({width: (d.width || f.width + d.widthAdjust) + "px"}).align(t({y: b + m + ("title" === a ? -3 : 2)}, d), !1, "spacingBox"), d.floating || d.verticalAlign || (b = Math.ceil(b + c.getBBox().height)))
                }, this);
                ...
                var a = this.options.chart, c = a.width, a = a.height, f = this.renderToClone || this.renderTo;
                ...
                this.container =
                    b = g("div", {id: h}, k, this.renderToClone || b);
                ...
                var c = this, f = c.options.chart, d = c.renderTo, m = b(f.width), h = f.width || e(d, "width"), f = f.height || e(d, "height"), d = a ? a.target : O;
                ...
                d.getChartSize();
                b = m.globalAnimation;
                (b ? A : f)(d.container, {width: d.chartWidth + "px", height: d.chartHeight + "px"}, b);
                d.setChartSize(!0);
                ...
                var b = this.inverted,
                    c = this.renderer, e = this.chartWidth, f = this.chartHeight, d = this.options.chart, m = this.spacing, h = this.clipOffset, k, g, q, l;
                ...
                this.plotBox =
                    c.plotBox = {x: k, y: g, width: q, height: l};
                ...
                f[z]({x: l / 2, y: l / 2, width: c - l - h % 2, height: e - l - h % 2, r: a.borderRadius});
                z = "animate";
                ...
                z = "animate";
                m || (z = "attr", this.plotBorder = m = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                m.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
                m[z](m.crisp({x: D, y: u, width: t, height: r}, -m.strokeWidth()));
                this.isDirtyBox = !1
            ...
            renderLabels: function () {
                ...
                b.items && n(b.items, function (c) {
                    var e = t(b.style, c.style), f = D(e.left) + a.plotLeft, d = D(e.top) + a.plotTop + 12;
                    delete e.left;
                    delete e.top;
    ...
    (function (a) {
        var E, A = a.each, F = a.extend, H = a.erase, p = a.fireEvent, d = a.format, g = a.isArray, v = a.isNumber, l = a.pick, r = a.removeEvent;
        E = a.Point = function () {
        };
        E.prototype = {
            init: function (a, b, d) {
                ...
                var b = {}, f = this.series, d = f.options.keys, l = d || f.pointArrayMap || ["y"], k = l.length, e = 0, h = 0;
                if (v(a) || null === a)b[l[0]] = a; else if (g(a))for (!d && a.length > k && (f = typeof a[0], "string" === f ? b.name = a[0] : "number" === f && (b.x = a[0]), e++); h < k;)d && void 0 === a[e] || (b[l[h]] =
                    a[e]), e++, h++; else"object" === typeof a && (b = a, a.dataLabels && (f._hasPointLabels = !0), a.marker && (f._hasPointMarkers = !0));
                return b
                ...
                var b = this.series, f = b.tooltipOptions, g = l(f.valueDecimals, ""), t = f.valuePrefix || "", k = f.valueSuffix || "";
    ...
    (function (a) {
        var E = a.addEvent, A = a.animObject, F = a.arrayMax, H = a.arrayMin, p = a.correctFloat, d = a.Date, g = a.defaultOptions, v = a.defaultPlotOptions, l = a.defined, r = a.each, f =
            a.erase, b = a.error, n = a.extend, w = a.fireEvent, t = a.grep, k = a.isArray, e = a.isNumber, h = a.isString, C = a.merge, u = a.pick, c = a.removeEvent, q = a.splat, x = a.stableSort, K = a.SVGElement, I = a.syncTimeout, J = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            coll: "series",
            init: function (a, b) {
                var c = this, e, f, d = a.series, h, k = function (a, b) {
            ...
            autoIncrement: function () {
                var a = this.options, b = this.xIncrement, c, e = a.pointIntervalUnit, b = u(b, a.pointStart, 0);
            ...
            getCyclic: function (a, b, c) {
                var e, f = this.userOptions, d = a + "Index", h = a + "Counter", k = c ? c.length : u(this.chart.options.chart[a + "Count"], this.chart[a + "Count"]);
            ...
            setData: function (a, c, f, d) {
                ...
                if (!1 !== d && q && n === q && !m.cropped && !m.hasGroupedData && m.visible)r(a, function (a, b) {
                    ...
                    if (x && q > x) {
                        ...
                        if (e(D))for (f = 0; f < q; f++)G[f] = this.autoIncrement(), w[f] = a[f]; else if (k(D))if (v)for (f = 0; f < q; f++)D = a[f], G[f] = D[0], w[f] = D.slice(1, v + 1); else for (f = 0; f < q; f++)D = a[f], G[f] =
                            D[0], w[f] = D[1]; else b(12)
                    } else for (f = 0; f < q; f++)void 0 !== a[f] && (D = {series: m}, m.pointClass.prototype.applyOptions.apply(D, [a[f]]), m.updateParallelArrays(D, f));
                    h(w[0]) && b(14, !0);
                    m.data = [];
            ...
            processData: function (a) {
                ...
                d =
                    0;
                var h, k, g = this.xAxis, q, n = this.options;
                q = n.cropThreshold;
                var l = this.getExtremesFromAll || n.getExtremesFromAll, u = this.isCartesian, n = g && g.val2lin, t = g && g.isLog, r, D;
                if (u && !this.isDirty && !g.isDirty && !this.yAxis.isDirty && !a)return !1;
                g && (a = g.getExtremes(), r = a.min, D = a.max);
                if (u && this.sorted && !l && (!q || f > q || this.forceCrop))if (c[f - 1] < r || c[0] > D)c = [], e = []; else if (c[0] < r || c[f - 1] > D)d = this.cropData(this.xData, this.yData, r, D), c = d.xData, e = d.yData, d = d.start, h = !0;
            ...
            cropData: function (a, b, c, e) {
                var f = a.length, d = 0, h = f, k = u(this.cropShoulder, 1), g;
            ...
            generatePoints: function () {
                var a = this.options.data, b = this.data, c, e = this.processedXData, f = this.processedYData,
                    d = this.pointClass, h = e.length, g = this.cropStart || 0, k, n = this.hasGroupedData, l, u = [], t;
                ...
                if (b && (h !== (c = b.length) || n))for (t = 0; t < c; t++)t !== g || n || (t += h), b[t] && (b[t].destroyElements(), b[t].plotX = void 0);
                this.data = b;
                this.points = u
            },
            getExtremes: function (a) {
                ...
                var g = f.min, q = f.max, n, l, t, u;
                a = a || this.stackedYData || this.processedYData || [];
                f = a.length;
                for (u = 0; u < f; u++)if (l = c[u], t = a[u], n = (e(t, !0) || k(t)) && (!b.isLog || t.length || 0 < t), l = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[u + 1] || l) >= g && (c[u - 1] || l) <= q, n && l)if (n = t.length)for (; n--;)null !== t[n] && (d[h++] = t[n]); else d[h++] = t;
                this.dataMin = H(d);
                this.dataMax = F(d)
            },
            translate: function () {
                ...
                this.generatePoints();
                var a =
                    this.options, b = a.stacking, c = this.xAxis, f = c.categories, d = this.yAxis, h = this.points, g = h.length, k = !!this.modifyValue, n = a.pointPlacement, q = "between" === n || e(n), t = a.threshold, r = a.startFromThreshold ? t : 0, x, w, v, I, K = Number.MAX_VALUE;
                "between" === n && (n = .5);
                e(n) && (n *= u(a.pointRange || c.pointRange));
                for (a = 0; a < g; a++) {
                    var C = h[a], J = C.x, A = C.y;
                    w = C.low;
                    var E = b && d.stacks[(this.negStacks && A < (r ? 0 : t) ? "-" : "") + this.stackKey], F;
            ...
            setClip: function (a) {
                var b = this.chart, c = this.options, e = b.renderer, f = b.inverted, d = this.clipBox,
                    h = d || b.clipBox, g = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, h.height, c.xAxis, c.yAxis].join(), k = b[g], n = b[g + "m"];
                k || (a && (h.width = 0, b[g + "m"] = n = e.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[g] = k = e.clipRect(h), k.count = {length: 0});
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker, e = a && a.options, f = e && e.marker || {}, d = this.color, h = e && e.color, g = a &&
                    a.color, e = u(f.lineWidth, c.lineWidth), k;
            ...
            destroy: function () {
                var a = this, b = a.chart, e = /AppleWebKit\/533/.test(J.navigator.userAgent), d, h = a.data || [], k, g, n;
                w(a,
                    "destroy");
                c(a);
            ...
            getGraphPath: function (a, b, c) {
                ...
                r(a, function (h, m) {
                    var q = h.plotX, t = h.plotY, u = a[m - 1];
            ...
            drawGraph: function () {
                ...
                r(e, function (e, f) {
                    var d = e[0], h = a[d];
                    h ? (h.endX = c.xMap, h.animate({d: c})) : c.length && (a[d] = a.chart.renderer.path(c).addClass(e[1]).attr({zIndex: 1}).add(a.group),
                        h = {
                            stroke: e[2],
            ...
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer, e = this.zones, f, d, h = this.clips || [], k, g = this.graph, n = this.area, q = Math.max(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], t, p, x = b.inverted, w, v, I, K, C = !1;
                ...
                l.min && (p = l.reversed, w = l.horiz, g && g.hide(), n && n.hide(), t = l.getExtremes(), r(e, function (e, m) {
                    ...
                    x && c.isVML && (k = l.isXAxis ? {x: 0, y: p ? I : K, height: k.width, width: b.chartWidth} :
            ...
            plotGroup: function (a, b, c, e, f) {
                var d = this[a], h =
                    !d;
                h && (this[a] = d = this.chart.renderer.g(b).attr({zIndex: e || .1}).add(f), d.addClass("highcharts-series-" + this.index + " highcharts-" + this.type + "-series highcharts-color-" + this.colorIndex + " " + (this.options.className || "")));
            ...
            render: function () {
                var a = this,
                    b = a.chart, c, e = a.options, f = !!a.animate && b.renderer.isSVG && A(e.animation).duration, d = a.visible ? "inherit" : "hidden", h = e.zIndex, k = a.hasRendered, g = b.seriesGroup, n = b.inverted;
            ...
            redraw: function () {
                var a = this.chart, b = this.isDirty || this.isDirtyData, c = this.group, e = this.xAxis, f = this.yAxis;
                c && (a.inverted && c.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), c.animate({translateX: u(e && e.left, a.plotLeft), translateY: u(f && f.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchKDTree: function (a, b) {
                function c(a, b, k, g) {
                    var m = b.point, n = e.kdAxisArray[k % g], q, t, u = m;
                ...
                var e =
                    this, f = this.kdAxisArray[0], d = this.kdAxisArray[1], h = b ? "distX" : "dist";
    ...
    (function (a) {
        ...
        var A = a.Axis, F = a.Chart, H = a.correctFloat, p = a.defined, d = a.destroyObjectProperties, g = a.each, v = a.format, l = a.pick;
        a = a.Series;
        E.prototype = {
            destroy: function () {
                d(this, this.axis)
            }, render: function (a) {
                var f = this.options, b = f.format, b = b ? v(b, this) : f.formatter.call(this);
                ...
                var b = this.axis, d = b.chart, g = d.inverted, l = b.reversed, l = this.isNegative && !l || !this.isNegative && l, k = b.translate(b.usePercentage ? 100 : this.total, 0, 0, 0, 1), b = b.translate(0), b = Math.abs(k - b);
                a = d.xAxis[0].translate(this.x) + a;
                var e = d.plotHeight, g = {
                    x: g ? l ? k : k - b : a,
        ...
        A.prototype.renderStackTotals = function () {
            var a = this.chart, f = a.renderer, b = this.stacks, d, g, l = this.stackTotalGroup;
        ...
        A.prototype.resetStacks = function () {
            ...
            if (!this.isXAxis)for (f in a)for (b in a[f])a[f][b].touched < this.stacksTouched ? (a[f][b].destroy(),
                delete a[f][b]) : (a[f][b].total = null, a[f][b].cum = null)
        };
        A.prototype.cleanStacks = function () {
            var a, f, b;
            if (!this.isXAxis)for (f in this.oldStacks && (a = this.stacks = this.oldStacks), a)for (b in a[f])a[f][b].cum = a[f][b].total
        };
        a.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var a = this.processedXData, f = this.processedYData, b = [], d = f.length, g = this.options, t = g.threshold, k = g.startFromThreshold ? t : 0, e = g.stack, g = g.stacking, h = this.stackKey,
                    v = "-" + h, u = this.negStacks, c = this.yAxis, q = c.stacks, x = c.oldStacks, K, I, J, D, G, A, F;
                c.stacksTouched += 1;
    ...
    (function (a) {
        var E = a.addEvent, A = a.animate, F = a.Axis, H = a.createElement, p = a.css, d = a.defined, g = a.each, v = a.erase, l = a.extend, r = a.fireEvent, f = a.inArray, b = a.isNumber, n = a.isObject, w = a.merge, t = a.pick, k = a.Point, e = a.Series, h = a.seriesTypes,
            C = a.setAnimation, u = a.splat;
        l(a.Chart.prototype, {
            addSeries: function (a, b, e) {
                var c, f = this;
                a && (b = t(b, !0), r(f, "addSeries", {options: a}, function () {
                    c = f.initSeries(a);
                    f.isDirtyLegend = !0;
                    f.linkSeries();
                    b && f.redraw(e)
            ...
            showLoading: function (a) {
                ...
                e || (b.loadingDiv = e = H("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = H("span", {className: "highcharts-loading-inner"}, null, e), E(b, "redraw", d));
            ...
            update: function (a, e) {
                var c, h = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, k = a.chart, n, q;
                if (k) {
                ...
                for (c in a) {
                    if (this[c] && "function" === typeof this[c].update)this[c].update(a[c], !1); else if ("function" === typeof this[h[c]])this[h[c]](a[c]);
        ...
        l(e.prototype, {
            addPoint: function (a,
                                b, e, f) {
                var c = this.options, d = this.data, h = this.chart, g = this.xAxis && this.xAxis.names, k = c.data, n, m, q = this.xData, l, u;
                b = t(b, !0);
                n = {series: this};
                this.pointClass.prototype.applyOptions.apply(n, [a]);
                u = n.x;
                l = q.length;
                if (this.requireSorting && u < q[l - 1])for (m = !0; l && q[l - 1] > u;)l--;
                ...
                var c = this, f = c.data, d = f[a], h = c.points, g = c.chart, k = function () {
                ...
                var c = this, e = this.chart, f = this.userOptions, d = this.type, k = a.type || f.type || e.options.chart.type, n = h[d].prototype, q = ["group", "markerGroup", "dataLabelsGroup"], u;
    ...
    (function (a) {
        var E = a.color, A = a.each, F = a.map, H = a.pick, p = a.Series, d = a.seriesType;
            ...
            singleStacks: !1, getStackPoints: function () {
                ...
                if (this.options.stacking) {
                    ...
                    A(d, function (c, g) {
                        ...
                        if (b[c] && !b[c].isNull)a.push(b[c]), A([-1, 1], function (a) {
                            var n = 1 === a ? "rightNull" : "leftNull", l = 0, t = f[d[g + a]];
                            if (t)for (C = w; 0 <= C && C < k;)q = t.points[C], q || (C === w ? b[c][n] = !0 : e[C] && (u = f[c].points[C]) && (l -= u[1] - u[0])), C += h;
                ...
                var d = p.prototype.getGraphPath, g = this.options, r = g.stacking, f = this.yAxis, b, n, w = [], t = [], k = this.index, e, h = f.stacks[this.stackKey], C = g.threshold, u = f.getThreshold(g.threshold), c, g = g.connectNulls || "percent" === r, q = function (b, c, d) {
                    ...
                    void 0 !== q && (t.push({
                        ...
                        isNull: g
                    }), w.push({plotX: e, plotY: null === l ? u : f.getThreshold(l), doCurve: !1}))
                };
                a = a || this.points;
                r && (a = this.getStackPoints());
                for (b = 0; b < a.length; b++)if (n = a[b].isNull, e = H(a[b].rectPlotX, a[b].plotX), c = H(a[b].yBottom, u), !n || g)g || q(b, b - 1, "left"), n && !r && g || (t.push(a[b]), w.push({
                    x: b,
                    plotX: e,
                    plotY: c
                })), g || q(b, b + 1, "right");
                ...
                A(r, function (f) {
                    var b = f[0], g = a[b];
                    g ? (g.endX = d.xMap, g.animate({d: d})) : (g = a[b] = a.chart.renderer.path(d).addClass(f[1]).attr({
                        fill: H(f[3],
    ...
    (function (a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function (a, F, H) {
                var p = F.plotX, d = F.plotY, g = a[H - 1];
                H = a[H + 1];
                var v, l, r, f;
    ...
    (function (a) {
        var E = a.animObject, A = a.color, F = a.each, H = a.extend, p = a.isNumber, d = a.merge, g = a.pick, v = a.Series, l = a.seriesType, r = a.svg;
        l("column", "line", {
            borderRadius: 0,
            groupPadding: .2,
            marker: null,
            ...
            getColumnMetrics: function () {
                var a = this, b = a.options, d = a.xAxis, l = a.yAxis, t = d.reversed, k, e = {}, h = 0;
                ...
                var p = Math.min(Math.abs(d.transA) * (d.ordinalSlope || b.pointRange || d.closestPointRange || d.tickInterval || 1), d.len), u = p * b.groupPadding, c = (p - 2 * u) / h, b = Math.min(b.maxPointWidth || d.len, g(b.pointWidth, c * (1 - 2 * b.pointPadding)));
                a.columnMetrics = {
                    width: b,
            ...
            translate: function () {
                var a = this, b = a.chart, d = a.options, l = a.dense = 2 > a.closestPointRange * a.xAxis.transA, l = a.borderWidth = g(d.borderWidth, l ? 0 : 1), t = a.yAxis, k = a.translatedThreshold = t.getThreshold(d.threshold), e = g(d.minPointLength,
                    5), h = a.getColumnMetrics(), p = h.width, u = a.barW = Math.max(p, 1 + 2 * l), c = a.pointXOffset = h.offset;
                b.inverted && (k -= .5);
                d.pointPadding && (u = Math.ceil(u));
                v.prototype.translate.apply(a);
                F(a.points, function (d) {
                    var f = g(d.yBottom, k), h = 999 + Math.abs(f), h = Math.min(Math.max(-h, d.plotY), t.len + h), n = d.plotX + c, l = u, q = Math.min(h, f), r, v = Math.max(h, f) - q;
            ...
            drawPoints: function () {
                var a = this, b = this.chart, g = a.options, l = b.renderer, t = g.animationLimit || 250, k;
                F(a.points, function (e) {
                    var f = e.graphic;
                    if (p(e.plotY) && null !== e.y) {
                        k =
                            e.shapeArgs;
                        if (f)f[b.pointCount < t ? "animate" : "attr"](d(k)); else e.graphic = f = l[e.shapeType](k).attr({"class": e.getClassName()}).add(e.group || a.group);
        ...
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, H = this.chart, p = 2 * (a.slicedOffset || 0), d = H.plotWidth - 2 * p, H = H.plotHeight -
                    2 * p, g = a.center, g = [E(g[0], "50%"), E(g[1], "50%"), a.size || "100%", a.innerSize || 0], v = Math.min(d, H), l, r;
    ...
    (function (a) {
        var E = a.addEvent, A = a.defined, F = a.each, H = a.extend, p = a.inArray, d = a.noop, g = a.pick, v = a.Point, l = a.Series, r = a.seriesType, f = a.setAnimation;
        r("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (a) {
                ...
                a || (F(d, function (a) {
                    ...
                    e && (e.attr({r: a.startR || b.center[3] / 2, start: f, end: f}), e.animate({
                        r: d.r,
                        start: d.start,
                        end: d.end
                    }, b.options.animation))
            ...
            translate: function (a) {
                this.generatePoints();
                var b = 0, d = this.options, f = d.slicedOffset, k = f + (d.borderWidth || 0), e, h, l, u = d.startAngle || 0, c = this.startAngleRad = Math.PI / 180 * (u - 90), u = (this.endAngleRad = Math.PI / 180 * (g(d.endAngle, u + 360) - 90)) - c, q = this.points, p = d.dataLabels.distance, d = d.ignoreHiddenPoint, r, v = q.length, A;
    ...
    (function (a) {
        var E =
            a.addEvent, A = a.arrayMax, F = a.defined, H = a.each, p = a.extend, d = a.format, g = a.map, v = a.merge, l = a.noop, r = a.pick, f = a.relativeLength, b = a.Series, n = a.seriesTypes, w = a.stableSort;
        ...
        b.prototype.drawDataLabels = function () {
            var a = this, b = a.options,
                e = b.dataLabels, f = a.points, g, l, c = a.hasRendered || 0, q, n, w = r(e.defer, !0), I = a.chart.renderer;
            if (e.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(e), n = a.plotGroup("dataLabelsGroup", "data-labels", w && !c ? "hidden" : "visible", e.zIndex || 6), w && (n.attr({opacity: +c}), c || E(a, "afterAnimate", function () {
                a.visible && n.show(!0);
                n[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), l = e, H(f, function (c) {
                var f, h = c.dataLabel, k, u, m = c.connector, t = !0, x, w = {};
                g = c.dlOptions || c.options && c.options.dataLabels;
                f = r(g && g.enabled, l.enabled) && null !== c.y;
                if (h && !f)c.dataLabel = h.destroy(); else if (f) {
                    e = v(l, g);
                    x = e.style;
                    f = e.rotation;
                    k = c.getLabelConfig();
                    ...
                    if (h)F(q) ? (h.attr({text: q}), t = !1) : (c.dataLabel = h = h.destroy(), m && (c.connector = m.destroy())); else if (F(q)) {
                        h = {
        ...
        b.prototype.alignDataLabel = function (a, b, e, d, f) {
            var g = this.chart, c = g.inverted,
                h = r(a.plotX, -9999), k = r(a.plotY, -9999), l = b.getBBox(), n, t = e.rotation, v = e.align, w = this.visible && (a.series.forceDL || g.isInsidePlot(h, Math.round(k), c) || d && g.isInsidePlot(h, c ? d.x + 1 : d.y + d.height - 1, c)), A = "justify" === r(e.overflow, "justify");
            w && (n = e.style.fontSize, n = g.renderer.fontMetrics(n, b).b, d = p({
                x: c ? g.plotWidth - k : h,
                y: Math.round(c ? g.plotHeight - h : k),
                width: 0,
                height: 0
            }, d), p(e, {width: l.width, height: l.height}), t ? (A = !1, c = g.renderer.rotCorr(n, t), c = {
                x: d.x + e.x + d.width / 2 + c.x, y: d.y + e.y + {top: 0, middle: .5, bottom: 1}[e.verticalAlign] *
                d.height
            }, b[f ? "attr" : "animate"](c).attr({align: v}), h = (t + 720) % 360, h = 180 < h && 360 > h, "left" === v ? c.y -= h ? l.height : 0 : "center" === v ? (c.x -= l.width / 2, c.y -= l.height / 2) : "right" === v && (c.x -= l.width, c.y -= h ? 0 : l.height)) : (b.align(e, null, d), c = b.alignAttr), A ? this.justifyDataLabel(b, e, c, l, d, f) : r(e.crop, !0) && (w = g.isInsidePlot(c.x, c.y) && g.isInsidePlot(c.x + l.width, c.y + l.height)), e.shape && !t && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
        ...
        b.prototype.justifyDataLabel = function (a, b, e, d, f, g) {
            var c =
                this.chart, h = b.align, k = b.verticalAlign, l, n, u = a.box ? 0 : a.padding || 0;
            l = e.x + u;
        ...
        n.pie && (n.pie.prototype.drawDataLabels = function () {
            var d = this, f = d.data, e, h = d.chart, l = d.options.dataLabels, n =
                r(l.connectorPadding, 10), c = r(l.connectorWidth, 1), q = h.plotWidth, p = h.plotHeight, v, w = l.distance, E = d.center, D = E[2] / 2, G = E[1], F = 0 < w, N, m, z, O, M = [[], []], y, B, Q, R, S = [0, 0, 0, 0];
            d.visible && (l.enabled || d._hasPointLabels) && (b.prototype.drawDataLabels.apply(d), H(f, function (a) {
                ...
                var f, k, u = b.length, r, t, v;
                if (u)for (d.sortByAngle(b, c - .5), 0 < w && (f = Math.max(0, G - D - w), k = Math.min(G + D + w, h.plotHeight), r = g(b, function (a) {
                ...
                if ((N = a.dataLabel) && N._pos && a.visible) {
                    ...
                    v[b ? "attr" : "animate"]({d: d.connectorPath(a.labelPos)});
                    v.attr("visibility", Q)
        ...
        n.column && (n.column.prototype.alignDataLabel = function (a, d, e, f, g) {
            var h = this.chart.inverted, c = a.series, k = a.dlBox || a.shapeArgs, l = r(a.below, a.plotY > r(this.translatedThreshold, c.yAxis.len)), n = r(e.inside, !!this.options.stacking);
    ...
    (function (a) {
        var E = a.Chart, A = a.each, F = a.pick, H = a.addEvent;
        ...
        E.prototype.hideOverlappingLabels = function (a) {
            var d = a.length, g, p, l, r, f, b, n, w, t, k = function (a, b, d, f, c, g, k, l) {
            ...
            for (p = 0; p < d; p++)for (l = a[p], g = p + 1; g < d; ++g)if (r = a[g], l && r && l.placed && r.placed && 0 !==
    ...
    (function (a) {
        var E = a.addEvent,
            A = a.Chart, F = a.createElement, H = a.css, p = a.defaultOptions, d = a.defaultPlotOptions, g = a.each, v = a.extend, l = a.fireEvent, r = a.hasTouch, f = a.inArray, b = a.isObject, n = a.Legend, w = a.merge, t = a.pick, k = a.Point, e = a.Series, h = a.seriesTypes, C = a.svg;
        a = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options, d = b.trackByArea, e = [].concat(d ? a.areaPath : a.graphPath), f = e.length, h = a.chart, k = h.pointer, l = h.renderer, n = h.options.tooltip.snap,
                    p = a.tracker, t, m = function () {
                        if (h.hoverSeries !== a)a.onMouseOver()
                    }, v = "rgba(192,192,192," + (C ? .0001 : .002) + ")";
                if (f && !d)for (t = f + 1; t--;)"M" === e[t] && e.splice(t + 1, 0, e[t + 1] - n, e[t + 2], "L"), (t && "M" === e[t] || t === f) && e.splice(t, 0, "L", e[t - 2] + n, e[t - 1]);
                p ? p.attr({d: e}) : a.graph && (a.tracker = l.path(e).attr({
                    "stroke-linejoin": "round",
        ...
        v(n.prototype, {
            setItemEvents: function (a, b, d) {
                var c = this, e = c.chart, f = "highcharts-legend-" + (a.series ? "point" : "series") + "-active";
        ...
        v(A.prototype, {
            showResetZoom: function () {
                var a = this, b = p.lang, d = a.options.chart.resetZoomButton, e = d.theme, f = e.states, g = "chart" === d.relativeTo ? null : "plotBox";
            ...
            pan: function (a, b) {
                ...
                g("xy" === b ? [1, 0] : [1], function (b) {
                    b = c[b ? "xAxis" : "yAxis"][0];
                    var d = b.horiz, f = b.reversed, g = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", h = c[d], k = (b.pointRange || 0) / (f ? -2 : 2), l = b.getExtremes(), n = b.toValue(h - g, !0) + k, k = b.toValue(h + b.len - g, !0) - k, h = h > g;
                    f && (h = !h, f = n, n = k, k = f);
                    b.series.length && (h || n > Math.min(l.dataMin, l.min)) && (!h || k < Math.max(l.dataMax, l.max)) && (b.setExtremes(n, k, !1, !1, {trigger: "pan"}), e = !0);
                    c[d] = g
                });
                e && c.redraw(!1);
        ...
        v(k.prototype, {
            select: function (a, b) {
                ...
                var c = this.series,
                    d = c.chart, e = d.tooltip, f = d.hoverPoint;
                if (this.series) {
                    if (!b) {
                ...
                var c = Math.floor(this.plotX), e = this.plotY, f = this.series, g = f.options.states[a] || {}, h = d[f.type].marker && f.options.marker, k = h && !1 === h.enabled, l = h && h.states && h.states[a] || {}, n = !1 === l.enabled, p = f.stateMarkerGraphic, m = this.marker || {}, r = f.chart, u = f.halo, w, y = h && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (n || k && !1 === l.enabled) || a && m.states &&
                    ...
                    if (this.graphic)this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(f.pointAttribs(this, a)), w && this.graphic.animate(w, t(r.options.chart.animation, l.animation, h.animation)), p && p.hide(); else {
                        if (a && l) {
                            h = m.symbol || f.symbol;
                    ...
                    (c = g.halo) && c.size ? (u || (f.halo = u = r.renderer.path().add(y ? f.markerGroup : f.group)), u[b ? "animate" : "attr"]({d: this.haloPath(c.size)}), u.attr({"class": "highcharts-halo highcharts-color-" + t(this.colorIndex, f.colorIndex)}), u.attr(v({
                        fill: this.color || f.color,
                        "fill-opacity": c.opacity,
                        zIndex: -1
                    }, c.attributes))) : u && u.animate({d: this.haloPath(0)});
                    this.state = a
                }
            }, haloPath: function (a) {
        ...
        v(e.prototype, {
            onMouseOver: function () {
                ...
                var b = this, d = b.options, e = b.graph, f = d.states, h = d.lineWidth, d = 0;
                a = a || "";
                if (b.state !== a && (g([b.group, b.markerGroup], function (c) {
                        c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a))
                    }), b.state = a, !f[a] || !1 !== f[a].enabled) && (a && (h = f[a].lineWidth || h + (f[a].lineWidthPlus || 0)), e && !e.dashstyle))for (f = {"stroke-width": h}, e.attr(f); b["zone-graph-" + d];)b["zone-graph-" + d].attr(f), d += 1
    ...
    (function (a) {
        var E = a.Chart, A = a.each, F = a.inArray, H = a.isObject, p = a.pick, d = a.splat;
        ...
        E.prototype.matchResponsiveRule = function (d, v) {
            var g = this.respRules, r = d.condition, f;
        ...
        E.prototype.currentOptions = function (a) {
            function g(a, f, b) {
                var l, p;
                for (l in a)if (-1 < F(l, ["series", "xAxis", "yAxis"]))for (a[l] = d(a[l]), b[l] = [], p = 0; p < a[l].length; p++)b[l][p] = {}, g(a[l][p], f[l][p], b[l][p]); else H(a[l]) ? (b[l] = {}, g(a[l], f[l] || {}, b[l])) : b[l] = f[l] || null
            }
