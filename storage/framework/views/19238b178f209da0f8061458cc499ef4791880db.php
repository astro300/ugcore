...
<?php $__env->startSection('mainContent'); ?>
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1">
                <?php echo Form::open(['id'=>'formasigna',null,'method'=>'POST', 'class'=>'form-horizontal']); ?>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Facultad</label>
                        <div class="col-lg-9">
                            <?php echo Form::select('hfacultad', $listaFacultad, null,['class' => 'form-control select-search','placeholder'=>'-Seleccione-','required' => 'required',"id"=>'hfacultad']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <?php echo Form::select('hcarrera',[], null,['class' => 'form-control select2','empty'=>'-Seleccione-','required' => 'required',"id"=>'hcarrera']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <?php echo Form::select('hplectivo', [], null,['class' => 'form-control select2','placeholder'=>'-Seleccione-','required' => 'required',"id"=>'hplectivo']); ?>
                        ...
                        <div class="col-lg-3">
                            <div class="input-group">
                                ...
                                <div id="drag" ondrop="drop(event)" ondragover="allowDrop(event)" >
                                    <?php echo Form::time('tiempo', '',  ["required"=>"required","class"=>"form-control",'id'=>'tiempo',"autocomplete"=>"off","redonly"=>"redonly","draggable"=>"true","ondragstart"=>"start(event)"]); ?>
...
<?php $__env->startSection('masterJsCustom'); ?>
    <?php echo Html::script('/js/modules/academico/Horarios/eventosHorarios.js'); ?>

    <?php echo Html::script('https://swisnl.github.io/jQuery-contextMenu/dist/jquery.contextMenu.js'); ?>

    <?php echo Html::style('https://swisnl.github.io/jQuery-contextMenu/dist/jquery.contextMenu.css'); ?>
