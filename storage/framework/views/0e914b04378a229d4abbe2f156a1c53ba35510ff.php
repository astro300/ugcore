...
<div class="col-lg-8 col-lg-offset-2">
  ...
  <?php echo Form::open(['route'=> ['admin.roles.update',$objRoles],'method'=>'PUT', 'class'=>'form-horizontal']); ?>
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                     <?php echo Form::label('nombre','Nombre Rol:',["class"=>"text-bold col-lg-3 control-label"]); ?>  
                      <div class="col-lg-9">
                     <?php echo Form::text('nombre',  $objRoles->name,  ["required"=>"required","class"=>"form-control" ]); ?>
                     ...
                     <div class="col-lg-9">
                                    <?php echo Form::text('nombre_largo', $objRoles->display_name,["required"=>"required","class"=>"form-control" ]); ?>

                    </div>  </div>
                    <div class="form-group">
                     <?php echo Form::label('descripcion','Descripcion: ',["class"=>"text-bold col-lg-3 control-label"]); ?>  
                     <div class="col-lg-9">
                                    <?php echo Form::text('descripcion', $objRoles->description,["required"=>"required","class"=>"form-control" ]); ?>
