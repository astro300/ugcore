          ...
          <div class="nav-tabs-custom">
            ...
            <div class="panel-footer">
              ...
              <div class="tab-pane" id="tab_4">
                          ...
                          <?php echo Field::text('nombre_estudiante',' ',['class'=>'form-control','id'=>'cedula_estudiante','placeholder'=>'Cédula del Estudiante', 'label'=>'CÉDULA DEL ESTUDIANTE:']); ?>


                            <?php echo Field::text('nombre_estudiante',' ',['class'=>'form-control','id'=>'nombre_estudiante','placeholder'=>'Nombre del Estudiante', 'label'=>'NOMBRE DEL ESTUDIANTE:']); ?>
