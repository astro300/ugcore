...
<header class="main-header">
    ...
    width: 100px;">
            ...
            <nav class="site-nav">
                <?php if(Auth::guest()): ?>
                    <a class="btn btn-outlined" href="<?php echo e(route('login')); ?>">INGRESO</a>&nbsp;
                    <a class="btn btn-outlined" href="<?php echo e(route('register')); ?>">REGISTRO</a>
                <?php endif; ?>
            </nav>
        </div>
    </div>
...
<div class="content-box">
    ...
    <section class="section section-hero">
        <div class="hero-box" style="<?php echo $__env->yieldContent('paddingDefaultFront',''); ?>">
    ...
    <section class="section section-destination">
        ...
        <div class="section-title">
            <div class="container">
                <h2 class="title"><?php echo $__env->yieldContent('sectionTitle','INFORMACI&Oacute;N ACAD&Eacute;MICA'); ?></h2>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <?php echo $__env->yieldContent('sectionContent',''); ?>
            </div>
        </div>
    </section>
